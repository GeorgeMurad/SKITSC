...
<body>
     ...
     <section class="container py-2 mb-4">
        ...
        <div class ="row">
            <div class="offset-lg-3 col-lg-6" style="height:375px;">
                    ...
                    <form class="" action="index.php" method="post">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">                                                 
                              <input type="text" class="form-control" value="" id="username" name="Username1">                    
                            </div>                   
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">                            
                              <input type="text" class="form-control" value="" id="username" name="Username2">                    
                            </div>                   
                        </div>
                        <br>
                        <input type="submit" name="Submit" class="btn btn-info btn-block" value="Back To Mian Page">                         
